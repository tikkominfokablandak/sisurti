        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><i class="fas fa-user-plus"></i> Form OPD Baru</h3>
              </div>
              <!-- /.card-header -->
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input id="nama_opd" type="text" class="form-control @error('nama_opd') is-invalid @enderror" name="nama_opd" value="{{ old('nama_opd') }}" placeholder="Masukan nama OPD ..." required autocomplete="nama_opd" autofocus oninvalid="this.setCustomValidity('Mohon isi nama OPD terlebih dahulu!')" oninput="setCustomValidity('')">
                            ...
                            <div class="form-group">
                                ...
                                <input id="singkatan" type="text" class="form-control @error('singkatan') is-invalid @enderror" placeholder="Masukan singkatan OPD ..." name="singkatan" value="{{ old('singkatan') }}" required autocomplete="singkatan" autofocus oninvalid="this.setCustomValidity('Mohon isi Singkatan terlebih dahulu!')" oninput="setCustomValidity('')">
