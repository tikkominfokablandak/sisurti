...
@section('title')
    | Edit Surat Masuk #{{ $suratmasuk->id }}
@endsection
        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
              ...
              <form method="POST" action="{{ route('surat-masuk.update', [$suratmasuk->id]) }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input id="nama_pengirim" type="text" class="form-control form-control @error('nama_pengirim') is-invalid @enderror" placeholder="Masukan Nama Pengirim ..." name="nama_pengirim" value="{{ $suratmasuk->nama_pengirim }}" required autocomplete="username" autofocus oninvalid="this.setCustomValidity('Mohon isi Nama Pengirim terlebih dahulu!')" oninput="setCustomValidity('')">
                            ...
                            <div class="form-group">
                                ...
                                <input id="jabatan_pengirim" type="text" class="form-control form-control @error('jabatan_pengirim') is-invalid @enderror" placeholder="Masukan Jabatan Pengirim ..." name="jabatan_pengirim" value="{{ $suratmasuk->jabatan_pengirim }}" required autocomplete="jabatan_pengirim" autofocus oninvalid="this.setCustomValidity('Mohon isi Jabatan Pengirim terlebih dahulu!')" oninput="setCustomValidity('')">
                            ...
                            <div class="form-group">
                                ...
                                <input id="instansi_pengirim" type="text" class="form-control form-control @error('instansi_pengirim') is-invalid @enderror" placeholder="Masukan Instansi Pengirim ..." name="instansi_pengirim" value="{{ $suratmasuk->instansi_pengirim }}" required autocomplete="instansi_pengirim" autofocus oninvalid="this.setCustomValidity('Mohon isi Instansi Pengirim terlebih dahulu!')" oninput="setCustomValidity('')">
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <select id="jenis_surat" class="form-control form-control-sm @error('jenis_surat') is-invalid @enderror" style="width: 100%;" name="id_jenissurat" required oninvalid="this.setCustomValidity('Mohon pilih jenis surat dahulu!')" oninput="setCustomValidity('')">
                                    <option value="{{ $suratmasuk->id_jenissurat }}">{{ $suratmasuk->jenis_surat }}</option>
                            ...
                            <div class="form-group">
                                ...
                                <select id="sifat_surat" class="form-control form-control-sm @error('sifat_surat') is-invalid @enderror" style="width: 100%;" name="sifat_surat" required oninvalid="this.setCustomValidity('Mohon pilih sifat surat dahulu!')" oninput="setCustomValidity('')">
                                    <option value="{{ $suratmasuk->sifat_surat }}">{{ $suratmasuk->sifat_surat }}</option>
                            ...
                            <div class="form-group">
                                ...
                                <select id="tingkat_urgen" class="form-control form-control-sm @error('tingkat_urgen') is-invalid @enderror" style="width: 100%;" name="tingkat_urgen" required oninvalid="this.setCustomValidity('Mohon pilih tingkat urgensi dahulu!')" oninput="setCustomValidity('')">
                                    <option value="{{ $suratmasuk->tingkat_urgen }}">{{ $suratmasuk->tingkat_urgen }}</option>
                                    <option value="BIASA">BIASA</option>
                                    <option value="PENTING">PENTING</option>
                            ...
                            <div class="form-group">
                                ...
                                <input id="no_surat" type="text" class="form-control @error('no_surat') is-invalid @enderror" placeholder="Masukan Nomor Surat ..." name="no_surat" value="{{ $suratmasuk->no_surat }}" required autocomplete="no_surat" autofocus oninvalid="this.setCustomValidity('Mohon isi Nomor Surat terlebih dahulu!')" oninput="setCustomValidity('')">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" name="tgl_surat" data-target="#reservationdate"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                    <input type="text" class="form-control datetimepicker-input" name="tgl_diterima" data-target="#reservationdate"/>
                                    <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                                        <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                ...
                                <textarea name="perihal" rows="3" class="form-control" id="perihal" placeholder="Masukkan hal...">{{ $suratmasuk->perihal }}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="isi" rows="8" class="form-control" id="isi" placeholder="Masukkan isi ringkas...">{{ $suratmasuk->isi }}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input @error('file_surat') is-invalid @enderror" id="customFile" name="file_surat" value="{{ $suratmasuk->file_surat }}">
                                        <label class="custom-file-label" for="customFile">{{ $suratmasuk->file_surat }}</label>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <small style="color:red">
                                        ...
                                        <br>
                                        Biarkan jika tidak mengganti file
                                    </small>
                                </div>
                            </div>
                        </div>
                ...
                <iframe src="{{ asset('storage/'.$suratmasuk->id_create.'/suratmasuk/'.$suratmasuk->file_surat) }}" align="top" height="1000" width="100%" frameborder="1" scrolling="auto"></iframe>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select id="tujuans" class="form-control form-control-sm @error('tujuan') is-invalid @enderror" style="width: 100%;" name="id_tujuan" required oninvalid="this.setCustomValidity('Mohon pilih tujuan dahulu!')" oninput="setCustomValidity('')">
                                    <option value="{{ $suratmasuk->id_tujuan }}">{{ $suratmasuk->nama }} - {{ $suratmasuk->nama_jabatan }} - {{ $suratmasuk->nama_unitkerja }} - {{ $suratmasuk->nama_opd }}</option>
