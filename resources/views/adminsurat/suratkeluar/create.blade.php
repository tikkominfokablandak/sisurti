                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="verifikator" class="form-control form-control-sm" style="width: 100%;" name="verifikator" required oninvalid="this.setCustomValidity('Mohon pilih verifikator dahulu!')" oninput="setCustomValidity('')">
                                    <option value=""></option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="penandatangan" class="form-control form-control-sm" style="width: 100%;" name="penandatangan" required oninvalid="this.setCustomValidity('Mohon pilih penandatangan dahulu!')" oninput="setCustomValidity('')">
                                    <option value=""></option>
