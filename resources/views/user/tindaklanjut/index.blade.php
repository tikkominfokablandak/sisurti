...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Tindak Lanjut - Daftar</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
            <li class="breadcrumb-item active">Daftar Tindak Lanjut</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th width="150">Status Tindak Lanjut</th>
                  <th width="10">Aksi</th>
                </tr>
                </thead>
                <tbody>
                ...
                <tr>
                    ...
                    <td>
                        Dari : {{ $item->nama_pengirim }} - {{ $item->jabatan_pengirim }} - {{ $item->instansi_pengirim }}
                        <br><br>
                        Hal : {{ $item->perihal }}
                    </td>
